...
<body>
    ...
    <div class="sidenav-header">
      ...
      <div class="d-flex align-items-center text-primary text-gradient text-sm font-weight-bold">
        ...
        <span class="ms-1 font-weight-bold">Fique no Azul</span></div>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Configurações da Conta</h6>
        </li>
        <li class="nav-item">
